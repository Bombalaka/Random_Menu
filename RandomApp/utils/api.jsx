...
export const getUsername = async () => {
    try {
        // Call register with dummy username - backend will return existing username if device is registered
        const result = await registerDevice('temp');
        // Backend returns { message: "...", username: "John" } when device is already registered
        ...
        console.log("Error getting username from backend:", error);
        return null;
    }
};
...
export const deleteFood = async (foodId) => {
    try {
        ...
        console.log("📡 DELETE /foods payload: deviceId:", deviceId, "foodId:", foodId);
        return { success: true, data: response.data };
    } catch (error) {
        return handleApiError(error);
    }
...
export const getSuggestedFoodByCriteria = async (criteria) => { 
    try {
        ...
        console.log("📡 GET /suggest-by-criteria payload: criteria:", criteria);
        return { success: true, data: response.data };
    } catch (error) {
        return handleApiError(error);
    }
